...
// //if you notice, above the function handleClick is called without (). To find out why, look at the undemy course video at est. time stamp 6:00 minutes.
...
document.addEventListener("keydown", function(event){ //here, entire documents listens for any key press
    console.log(event);
    makeSound(event.key);
...
function buttonAnimation(currentKey) {
 ...
 activeButton.classList.add("pressed"); //for this, look up "pressed" class in styles.css
